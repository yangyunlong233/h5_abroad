  ...
  <div id="UsrDValueBro" class="page">
    ...
    <Header back="true">
      ...
      <template v-slot:tool>
        <router-link class="header-tool" to="/d_bro_logs">贷款记录</router-link>
      </template>
    </Header>
    ...
    <div class="page-cont">
      <div class="page-panel usr-fn-panel">
        ...
        <div class="flex-column usr-fn">
          <div class="col-item"><input class="d" type="number" placeholder="请输入质押数量" v-model="inputBro"></div>
  ...
  setup () {
    ...
    function submitVerify () {
      if (agree.value === false) {
        msgDialog('请先同意质押借款协议')
      } else if (inputBro.value === '') {
        msgDialog('请输入回购数量')
